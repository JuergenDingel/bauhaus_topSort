...
@proposition(E)
class CoinComparisonProposition:
...
for coin1 in COIN:
    ...
    for coin2 in COIN:
#        if coin1 != coin2:
            lessThan[coin1].append(coin2)
print(lessThan)

# Atomic propositions capturing how the values of coins compare (atomic propositions for comparing coins)
# c1ltc2 = CoinComparisonProposition("c1ltc2")    # true iff value of coin c1 is less than value of coin c2
# c1ltc2 = CoinComparisonProposition(1,2)    # true iff value of coin c1 is less than value of coin c2
lessThan[1,2] = CoinComparisonProposition(1,2)    # true iff value of coin c1 is less than value of coin c2
# c1ltc3 = CoinComparisonProposition("c1ltc3")
# c1ltc3 = CoinComparisonProposition(1,3)    
lessThan[1,3] = CoinComparisonProposition(1,3)   
# c2ltc1 = CoinComparisonProposition("c2ltc1")
# c2ltc1 = CoinComparisonProposition(2,1)    
lessThan[2,1] = CoinComparisonProposition(2,1)   
# c2ltc3 = CoinComparisonProposition("c2ltc3")
# c2ltc3 = CoinComparisonProposition(2,3)    
lessThan[2,1] = CoinComparisonProposition(2,1)   
# c3ltc1 = CoinComparisonProposition("c3ltc1")
# c3ltc1 = CoinComparisonProposition(3,1)    
lessThan[2,1] = CoinComparisonProposition(2,1)   
# c3ltc2 = CoinComparisonProposition("c3ltc2")
# c3ltc2 = CoinComparisonProposition(3,2)    
lessThan[2,1] = CoinComparisonProposition(2,1)   

# Atomic propositions capturing where in the order a coin appears (APs for ordering coins)
# c1Atp1 = CoinOrderingProposition("c1@p1")    
c1Atp1 = CoinOrderingProposition(1,1)    # true iff coin c1 appears in position 1
# c1Atp2 = CoinOrderingProposition("c1@p2")   
c1Atp2 = CoinOrderingProposition(1,2)    
# c1Atp3 = CoinOrderingProposition("c1@p3")   
c1Atp3 = CoinOrderingProposition(1,3)    
# c2Atp1 = CoinOrderingProposition("c2@p1")    
c2Atp1 = CoinOrderingProposition(2,1)    
# c2Atp2 = CoinOrderingProposition("c2@p2")   
c2Atp2 = CoinOrderingProposition(2,2)    
# c2Atp3 = CoinOrderingProposition("c2@p3")   
c2Atp3 = CoinOrderingProposition(2,3)    
# c3Atp1 = CoinOrderingProposition("c3@p1")    
c3Atp1 = CoinOrderingProposition(3,1)    
# c3Atp2 = CoinOrderingProposition("c3@p2")   
c3Atp2 = CoinOrderingProposition(3,2)    
# c3Atp3 = CoinOrderingProposition("c3@p3")   
c3Atp3 = CoinOrderingProposition(3,3)    
...
def add_coinComparison_constraints():
    ...
    E.add_constraint(lessThan[1][2].implies(lessThan[2][1].negate()))
    # E.add_constraint(c1ltc3 >> ~c3ltc1)
    E.add_constraint(lessThan[1][3] >> ~lessThan[3][1]) 
    # E.add_constraint(c2ltc1 >> ~c1ltc2)
    E.add_constraint(lessThan[2][1] >> ~lessThan[1][2]) 
    # E.add_constraint(c2ltc3 >> ~c3ltc2)
    E.add_constraint(lessThan[2][3] >> ~lessThan[3][2]) 
    # E.add_constraint(c3ltc1 >> ~c1ltc3)
    E.add_constraint(lessThan[3][1] >> ~lessThan[1][3]) 
    #E.add_constraint(c3ltc2 >> ~c2ltc3)
    E.add_constraint(lessThan[3][2] >> ~lessThan[2][3]) 
    ...
    E.add_constraint((lessThan[1][2] & lessThan[2][3])>> lessThan[1][3]) 
    # E.add_constraint((c1ltc3 & c3ltc2) >> c1ltc2)
    E.add_constraint((lessThan[1][3] & lessThan[3][2])>> lessThan[1][2]) 
    # E.add_constraint((c2ltc1 & c1ltc3) >> c2ltc3)
    E.add_constraint((lessThan[2][1] & lessThan[1][3])>> lessThan[2][3]) 
    # E.add_constraint((c2ltc3 & c3ltc1) >> c2ltc1)
    E.add_constraint((lessThan[2][3] & lessThan[3][1])>> lessThan[2][1]) 
    # E.add_constraint((c3ltc1 & c1ltc2) >> c3ltc2)
    E.add_constraint((lessThan[3][1] & lessThan[1][2])>> lessThan[3][2]) 
    # E.add_constraint((c3ltc2 & c2ltc1) >> c3ltc1)
    E.add_constraint((lessThan[3][2] & lessThan[2][1])>> lessThan[3][1]) 
    return E
...
def add_coinOrdering_constraints():
    ...
    E.add_constraint((c1Atp1 & c2Atp2) >> lessThan[1][2])     
    # E.add_constraint((c1Atp1 & c3Atp2) >> c1ltc3)
    E.add_constraint((c1Atp1 & c3Atp2) >> lessThan[1][3])     
    # E.add_constraint((c2Atp1 & c1Atp2) >> c2ltc1)
    E.add_constraint((c2Atp1 & c1Atp2) >> lessThan[2][1])     
    # E.add_constraint((c2Atp1 & c3Atp2) >> c2ltc3)
    E.add_constraint((c2Atp1 & c3Atp2) >> lessThan[2][3])     
    # E.add_constraint((c3Atp1 & c1Atp2) >> c3ltc1)
    E.add_constraint((c3Atp1 & c1Atp2) >> lessThan[3][1])     
    # E.add_constraint((c3Atp1 & c2Atp2) >> c3ltc2)
    E.add_constraint((c3Atp1 & c2Atp2) >> lessThan[3][2])     

    # E.add_constraint((c1Atp2 & c2Atp3) >> c1ltc2)     # if c1 at l2 and c2 at l3, then c1 less than c2
    E.add_constraint((c1Atp2 & c2Atp3) >> lessThan[1][2])     
    # E.add_constraint((c1Atp2 & c3Atp3) >> c1ltc3)
    E.add_constraint((c1Atp2 & c3Atp3) >> lessThan[1][3])
    # E.add_constraint((c2Atp2 & c1Atp3) >> c2ltc1)
    E.add_constraint((c2Atp2 & c1Atp3) >> lessThan[2][1])
    # E.add_constraint((c2Atp2 & c3Atp3) >> c2ltc3)
    E.add_constraint((c2Atp2 & c3Atp3) >> lessThan[2][3])
    # E.add_constraint((c3Atp2 & c1Atp3) >> c3ltc1)
    E.add_constraint((c3Atp2 & c1Atp3) >> lessThan[3][1])
    # E.add_constraint((c3Atp2 & c2Atp3) >> c3ltc2)
    E.add_constraint((c3Atp2 & c2Atp3) >> lessThan[3][2])


    # every coin is in exactly one position 
    constraint.add_exactly_one(E, c1Atp1, c1Atp2, c1Atp3)
    constraint.add_exactly_one(E, c2Atp1, c2Atp2, c2Atp3)
    constraint.add_exactly_one(E, c3Atp1, c3Atp2, c3Atp3)
    ...
    constraint.add_exactly_one(E, c1Atp1, c2Atp1, c3Atp1)
    constraint.add_exactly_one(E, c1Atp2, c2Atp2, c3Atp2)
    constraint.add_exactly_one(E, c1Atp3, c2Atp3, c3Atp3)
